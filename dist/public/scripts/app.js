...
var GpCodersApp = function (_React$Component) {
    ...
    _createClass(GpCodersApp, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", null, React.createElement(Header, { title: title, subtitle: subtitle }), React.createElement(Action, null), React.createElement(OptionComponent, { options: options }), React.createElement(AddOptions, null));
        }
    }]);
...
var Action = function (_React$Component3) {
    ...
    _createClass(Action, [{
        ...
        key: "render",
        value: function render() {
            return React.createElement("div", null, React.createElement("button", { onClick: this.handlePick }, "What should i do ?"));
        }
    }]);
...
var OptionComponent = function (_React$Component4) {
    ...
    _createClass(OptionComponent, [{
        ...
        key: "render",
        value: function render() {
            return React.createElement("div", null, React.createElement("button", { onClick: this.removeAll }, "Remove All"), this.props.options.map(function (option, index) {
...
var AddOptions = function (_React$Component6) {
    ...
    _createClass(AddOptions, [{
        key: "render",
        value: function render() {
            return React.createElement("div", null, React.createElement("input", { type: "text" }), React.createElement("button", null, "Add New"));
        }
    }]);
